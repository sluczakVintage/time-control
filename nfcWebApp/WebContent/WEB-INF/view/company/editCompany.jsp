...
<form:form modelAttribute="editCompanyForm" method="POST" action="${updateCompanyUrl}">
	...
	<table>
		<tr> <td> Company ID : </td> <td> <form:input path="id" value="${company.id }" readonly="true" /></td> </tr>
		...
		<tr> <td> <form:label path="nip">NIP [*] :</form:label>  </td>	<td> <form:input path="nip" value="${company.nip}"/></td><td><form:errors cssClass="error" path="nip"/></td></tr>
