...
<c:url var="viewCompaniesUrl" value="/companies.html" />
<a href="${viewCompaniesUrl}">Show All Companies</a>
...
<table>
		...
		<tr> <td><form:label path="nip">NIP[*] : </form:label>  </td><td><form:input path="nip" /></td><td><form:errors cssClass="error" path="nip"/></td></tr>
		...
		<tr> <td> <form:label path="contactPersonName">Imię osoby kontakowej : </form:label>  </td><td><form:input path="contactPersonName"/> </td><td><form:errors cssClass="error" path="contactPersonName"/></td></tr>
		<tr> <td><form:label path="contactPersonLastName">Nazwisko osoby kontakowej: </form:label>  </td><td><form:input path="contactPersonLastName"/></td><td><form:errors cssClass="error" path="contactPersonLastName"/></td></tr>
		<tr> <td> <form:label path="contactPersonDescription">Opis osoby kontakowej</form:label> </td><td><form:input path="contactPersonDescription"/></td><td><form:errors cssClass="error" path="contactPersonDescription"/></td></tr>	
