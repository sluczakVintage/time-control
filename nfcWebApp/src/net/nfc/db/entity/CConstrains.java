...
public class CConstrains {
	...
	public static HashMap<String, String> getEventMap() {
		...
		eventStatusMap.put(eventStatus.FINISHED.getText(), "Zakoñczone");
		eventStatusMap.put(eventStatus.STARTED.getText(), "Rozpoczête");
		eventStatusMap.put(eventStatus.CLOSED.getText(), "Zamkniête");
