...
<div id="content">
<div class="post">
<span class="headerDescription">Szczegóły użytkownika</span> 
<br>
<br>
...
<c:if test="${!empty employee}">
	<table>
			...
			<tr> <td> Identyfikator </td><td><c:out value="${employee.user.id}" /> </td> </tr>
		...
		<p><a href="#" onclick="showhide('div1');">Nadaj Uprawnienie</a></p> 
			...
			<p><a href="/nfcWebApp/users.do">Wróć do listy</a></p>
		</div>
		<!-- end #sidebar -->
